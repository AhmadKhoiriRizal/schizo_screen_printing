            ...
            <div class="card-header">
                <div class="d-flex align-items-center">
                  ...
                  <button class="btn btn-primary btn-round ms-auto">
                    ...
                    <a href="{{ route('produk.create') }}" style="color: white">
            ...
            <table class="table datatable">
              <thead>
                <tr>
                    ...
                    <th class="col-xl-7">Kategori</th>
                    <th class="col-xl-2">Aksi</th>
                </tr>
            </thead>
            <tfoot>
                <tr>
                ...
                <tbody>
                    ...
                    <td class="col-xl-7">{{ $produk->kategori }}</td>
                    <td class="col-xl-2">
                        <div class="form-button-action d-flex">
                        <a href="{{ route('produk.edit', $produk->id)}}" class="btn btn-sm btn-icon text-info">
                        ...
                        <a href="{{ route('produk.view', $produk->id)}}" class="btn btn-sm btn-icon text-success">
                            <span class="btn-inner">
                        ...
                        <form action="{{ route('produk.destroy', $produk->id)}}" method="POST" onsubmit="return confirm('Apakah yakin akan dihapus?')">
                            @csrf
